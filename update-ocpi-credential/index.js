...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.patch(`${process.env.EVENTS_PROCESSOR_API_URL}/api/${process.env.EVENTS_PROCESSOR_API_VERSION}/ocpi-credential/${req.params.ocpiCredentialID}`, {
            json: true,
            headers: {
