...
module.exports = async (context, req) => {
    ...
    try {
        ...
        if (!req.body)
            req.body = {};
        const result = await request.post(`${process.env.CUSTOMER_API_URL}/api/${process.env.CUSTOMER_API_VERSION}/merchants/${req.params.id}/search-resources?languageCode=${user.languageCode}`, {
            json: true,
            headers: {
