...
//Please refer BASE-181 for this endpoint related details
...
module.exports = async (context, req) => {
    ...
    try {
        ...
        if (!req.body) {
            utils.setContextResError(
                ...
                new errors.EmptyRequestBodyError(
                    'You\'ve requested to create a new timeslots but the request body seems to be empty. Kindly pass the timeslots to be created using request body in application/json format',
                    400
                )
            );
        ...
        const result = await request.post(`${process.env.CUSTOMER_API_URL}/api/${process.env.CUSTOMER_API_VERSION}/timeslots`, {
            body: req.body,
            json: true,
            headers: {
