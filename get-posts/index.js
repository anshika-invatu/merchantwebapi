...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.CONTENTS_API_URL}/api/${process.env.CONTENTS_API_VERSION}/merchants/${req.params.id}/posts?${context.req.originalUrl.split('?')[1]}}`, {
            json: true,
            headers: {
