...
describe('Get Event Subscriber', () => {
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/event-subscriber/${sampleEventSubscribers._id}`, {
            json: true,
            headers: {
    ...
    it('should throw error on incorrect id field', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/event-subscriber/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
    ...
    it('should not get doc when module not exist', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/event-subscriber/${uuid.v4()}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
