...
describe('set-component-rental-customer', () => {
    ...
    it('should throw error if user not login', async () => {
        try {
            const url = `${helpers.API_URL}/api/v1/set-component-rental-customer`;
    ...
    it('should throw error if id is not in uuid format', async () => {
        try {
            await request.patch(`${helpers.API_URL}/api/v1/set-component-rental-customer`, {
                json: true,
                body: {
                    componentID: '123',
                    merchantID: merchantID,
            ...
            const response = {
                code: 400,
                description: 'The componentID field specified in the request body does not match the UUID v4 format.',
