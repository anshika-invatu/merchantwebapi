...
//Please refer the story BASE-8 for more details
...
module.exports = async (context, req) => {
    try {
        ...
        let result;
        if (isMerchantLinked) {
            result = await request.get(`${process.env.DEVICE_API_URL}/api/${process.env.DEVICE_API_VERSION}/pos-site-menu/${req.params.pointOfServiceID}`, {
                json: true,
                headers: {
                    'x-functions-key': process.env.DEVICE_API_KEY
                }
