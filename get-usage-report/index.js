...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.BILLING_SERVICE_API_URL}/api/${process.env.BILLING_SERVICE_VERSION}/merchants/${req.params.id}/usage-report?${context.req.originalUrl.split('?')[1]}`, {
            json: true,
            body: req.body,
            headers: {
