...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.post(`${process.env.EVENTS_PROCESSOR_API_URL}/api/${process.env.EVENTS_PROCESSOR_API_VERSION}/ticket-logs-group-by-hour/${req.params.id}`, {
            json: true,
            body: req.body,
            headers: {
