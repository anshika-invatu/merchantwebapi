...
describe('Set User Role', () => {
    ...
    it('should throw error if request body is empty', async () => {
        try {
            ...
            const response = {
                code: 400,
                description: 'Please provide body parameters merchantID,userID and role',
    ...
    it('should throw error if the role doesn\'t have correct value', async () => {
        try {
            await request.post(`${helpers.API_URL}/api/v1/set-user-role`, {
                json: true,
                body: {
            ...
            const response = {
                code: 400,
                description: 'Please provide correct value of role',
    ...
    it('should throw error if merchant not linked', async () => {
        try {
            await request.post(`${helpers.API_URL}/api/v1/set-user-role`, {
                json: true,
                body: {
            ...
            const response = {
                code: 401,
                description: 'user not allowed to modify role.',
                reasonPhrase: 'UserNotAuthenticatedError'
            };
