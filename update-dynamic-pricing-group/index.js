...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.patch(`${process.env.ENERGY_DATA_API_URL}/api/${process.env.ENERGY_DATA_API_VERSION}/dynamic-pricing-group/${req.params.dynamicPricingGroupID}`, {
            json: true,
            headers: {
