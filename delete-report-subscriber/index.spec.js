...
describe('delete-report-subscriber', () => {
    ...
    it('should return error when merchant id not matched.', async () => {
        try {
            await request.delete(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/report-subscriber/${sampleReportSubscribers._id}`, {
                json: true,
                headers: {
    ...
    it('should return error when id not correct.', async () => {
        ...
        try {
            await request.delete(`${helpers.API_URL}/api/v1/merchants/${sampleReportSubscribers.merchantID}/report-subscriber/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
    ...
    it('should delete doc when all validation pass', async () => {
        ...
        const result = await request.delete(`${helpers.API_URL}/api/v1/merchants/${sampleReportSubscribers.merchantID}/report-subscriber/${sampleReportSubscribers._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(result.description).to.equal('Successfully deleted the specified report-subscriber');
    });
