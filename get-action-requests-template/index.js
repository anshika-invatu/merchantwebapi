...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.EVENTS_PROCESSOR_API_URL}/api/${process.env.EVENTS_PROCESSOR_API_VERSION}/action-requests-template/${req.params.actionRequestsTemplateID}`, {
            json: true,
            headers: {
