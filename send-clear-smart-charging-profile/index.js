...
module.exports = async (context, req) => {
    ...
    if (!req.body || !req.body.pointOfServiceID) {
        utils.setContextResError(
            context,
            new errors.FieldValidationError(
                'Please provide pointOfServiceID in req body',
                400
            )
        );
        return Promise.reject();
    ...
    try {
        ...
        const result = await request.post(`${process.env.OCPP16_API_URL}/api/${process.env.OCPP16_API_VERSION}/clear-charging-profile`, {
            json: true,
            headers: {
