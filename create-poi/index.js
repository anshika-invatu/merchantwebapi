...
module.exports = async (context, req) => {
    ...
    try {
        ...
        if (!req.body) {
            utils.setContextResError(
                ...
                new errors.EmptyRequestBodyError(
                    'You\'ve requested to create a new pointOfInterest but the request body seems to be empty. Kindly pass the pointOfInterest to be created using request body in application/json format',
                    400
                )
            );
        ...
        const result = await request.post(`${process.env.POI_API_URL}/api/${process.env.POI_API_VERSION}/point-of-interest`, {
            body: req.body,
            json: true,
            headers: {
