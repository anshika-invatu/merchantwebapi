...
describe('Get POS status many', () => {
    ...
    it('should throw error if the user not login', async () => {
        try {
            await request.post(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/pos-status-filter`, {
    ...
    it('should get doc list when all validation pass', async () => {
        ...
        const response = await request.post(`${helpers.API_URL}/api/v1/merchants/${merchantID}/pos-status-filter`, {
            json: true,
            headers: {
