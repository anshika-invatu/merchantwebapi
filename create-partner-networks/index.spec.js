...
describe('Create Partner Network', () => {
    ...
    it('should return status code 400 when request body is null', async () => {
        try {
            ...
            const response = {
                code: 400,
                description: 'You\'ve requested to create a new partnerNetwork but the request body seems to be empty. Kindly pass the partnerNetwork to be created using request body in application/json format',
    ...
    after(async () => {
        ...
        await request.delete(process.env.VOUCHER_API_URL + `/api/${process.env.VOUCHER_API_VERSION}/merchants/${samplePartnerNetwork.partnerNetworkMembers[0].merchantID}/partner-networks/${samplePartnerNetwork._id}`, {
            json: true,
            headers: {
