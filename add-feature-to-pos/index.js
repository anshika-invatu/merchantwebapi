...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.post(`${process.env.MERCHANT_API_URL}/api/${process.env.MERCHANT_API_VERSION}/point-of-service/${req.params.id}/update-feature-to-pos/${req.params.featureID}`, {
            json: true,
            headers: {
