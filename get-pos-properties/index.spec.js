...
describe('Get posProperties', () => {
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const response = await request.get(`${helpers.API_URL}/api/v1/merchants/${merchantID}/pos-properties/${samplePosProperties.pointOfServiceID}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(response.pointOfServiceID).to.equal(samplePosProperties.pointOfServiceID);
    ...
    it('should throw 401 error if the merchantID is not linked to user', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/pos-properties/${uuid.v4()}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
