...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.delete(`${process.env.CUSTOMER_API_URL}/api/${process.env.CUSTOMER_API_VERSION}/merchants/${req.params.id}/resources/${req.params.resourceID}`, {
            json: true,
            headers: {
