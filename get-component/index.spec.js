...
describe('get-component', () => {
    ...
    it('should throw error if user not login', async () => {
        try {
            const url = `${helpers.API_URL}/api/v1/component/${uuid.v4()}`;
    ...
    it('should throw error if id is not in uuid format', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/component/123`, {
                json: true,
                headers: {
            ...
            const response = {
                code: 400,
                description: 'The components id specified in the URL does not match the UUID v4 format.',
    ...
    it('should throw error if component types not exist', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/component/${uuid.v4()}`, {
                json: true,
                headers: {
