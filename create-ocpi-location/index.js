        ...
        if (!req.body) {
            utils.setContextResError(
                ...
                new errors.EmptyRequestBodyError(
                    'You\'ve requested to create a new ocpiLocation but the request body seems to be empty. Kindly pass the ocpiLocation to be created using request body in application/json format',
                    400
                )
            );
