...
module.exports = async (context, req) => {
    try {
        ...
        if (isMerchantLinked) {
            const result = await request.patch(`${process.env.DEVICE_API_URL}/api/${process.env.DEVICE_API_VERSION}/merchants/${req.params.id}/module-templates/${req.params.moduleTemplateID}`, {
                json: true,
                headers: {
