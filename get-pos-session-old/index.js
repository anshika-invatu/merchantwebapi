...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const posSession = await request.get(`${process.env.ORDER_API_URL}/api/${process.env.ORDER_API_VERSION}/pos-session-old/${req.params.posSessionID}?${context.req.originalUrl.split('?')[1]}`, {
            json: true,
            headers: {
