...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.patch(`${process.env.CUSTOMER_API_URL}/api/${process.env.CUSTOMER_API_VERSION}/merchants/${req.params.id}/timeslots/${req.params.timeslotID}`, {
            json: true,
            headers: {
