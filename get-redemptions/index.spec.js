...
describe('Get Redemptions', () => {
    ...
    it('should throw error if user not login', async () => {
        try {
            const url = `${helpers.API_URL}/api/v1/merchants/${123}/redemption/2016-10-10/2017-10-12`;
    ...
    it('should throw error if merchantID not linked to user', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/redemption/2016-10-10/2017-10-12`, {
                json: true,
                headers: {
