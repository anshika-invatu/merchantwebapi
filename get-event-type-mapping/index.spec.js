...
describe('Get Event Type Mapping', () => {
    ...
    it('should throw error if id is not uuid', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/event-type-mapping/123`, {
                json: true,
                headers: {
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/event-type-mapping/${sampleEventTypesMapping._id}`, {
            body: sampleEventTypesMapping,
            json: true,
            headers: {
                'Authorization': authToken
    ...
    it('should not get doc when module not exist', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/event-type-mapping/${uuid.v4()}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
