...
describe('Update Partner Network Members', () => {
    ...
    it('should return status code 400 when request body is null', async () => {
        try {
            await request.patch(helpers.API_URL + '/api/v1/partner-networks/' + samplePartnerNetwork._id, {
                json: true,
                headers: {
            ...
            const response = {
                code: 400,
                description: 'You\'ve requested to update partnerNetworkMember but the request body seems to be empty. Kindly pass the partnerNetworkMember fields to be updated using request body in application/json format',
