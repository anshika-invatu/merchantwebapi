...
describe('Get DynamicPricingGroups by merchantID', () => {
    before(async () => {
    ...
    it('should get doc list when all validation pass', async () => {
        ...
        const response = await request.get(`${helpers.API_URL}/api/v1/merchants/${merchantID}/dynamic-pricing-groups`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(response[0]._id).to.equal(sampleDynamicPricingGroups._id);
