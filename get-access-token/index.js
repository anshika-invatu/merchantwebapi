...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.DEVICE_API_URL}/api/${process.env.DEVICE_API_VERSION}/merchants/${req.params.id}/access-token?${context.req.originalUrl.split('?')[1]}`, {
            json: true,
            headers: {
