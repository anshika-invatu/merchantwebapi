...
describe('Get Landing Page', () => {
    ...
    it('should update schedules doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/landing-page/${sampleLandingPages._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
    ...
    it('should not delete schedules when db don\'t have schedules with this id.', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/landing-page/${uuid.v4()}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                },
    ...
    it('should return error when id is not in uuid format', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/landing-page/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                },
