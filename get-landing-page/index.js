...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.MERCHANT_API_URL}/api/${process.env.MERCHANT_API_VERSION}/landing-page/${req.params.id}`, {
            json: true,
            headers: {
        ...
        if (isAbleToGet) {
            ...
            utils.setContextResError(
                context,
                new errors.LandingPageNotFoundError(
