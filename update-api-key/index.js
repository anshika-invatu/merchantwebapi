...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.patch(`${process.env.MERCHANT_API_URL}/api/${process.env.MERCHANT_API_VERSION}/merchants/${req.params.id}/api-key/${req.params.apiKeyID}`, {
            json: true,
            headers: {
