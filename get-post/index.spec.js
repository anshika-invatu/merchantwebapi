...
describe('Get Post', () => {
    ...
    it('should return error when id not correct.', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${samplePost.merchantID}/posts/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/merchants/${samplePost.merchantID}/posts/${samplePost._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(result._id).to.equal(samplePost._id);
    });
