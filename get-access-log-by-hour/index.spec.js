...
describe('Get AccessLog by pointOfService', () => {
    ...
    it('should return the document when all validation passes', async () => {
        ...
        const result = await request.post(`${helpers.API_URL}/api/v1/merchants/${sampleUser.merchants[0].merchantID}/access-log-by-hour`, {
            json: true,
            headers: {
    ...
    it('should return empty array with parameters', async () => {
