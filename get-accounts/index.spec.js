...
describe('Get accounts', () => {
    ...
    it('should throw error if request id is not  uuid', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/123/accounts/${sampleAccounts._id}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/merchants/${merchantID}/accounts/${sampleAccounts._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
    ...
    it('should not create doc when module does not exist', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${merchantID}/accounts/${uuid.v4()}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
