...
module.exports = async (context, req) => {
    try {
        ...
        const result = await request.patch(`${process.env.EVENTS_PROCESSOR_API_URL}/api/${process.env.EVENTS_PROCESSOR_API_VERSION}/integration/${req.params.id}`, {
            json: true,
            headers: {
                'x-functions-key': process.env.EVENTS_PROCESSOR_API_KEY
            },
            body: { userMerchants: userMerchants, updatedIntegration: req.body }
        });
