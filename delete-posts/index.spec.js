...
describe('Delete Post', () => {
    ...
    it('should return error when merchant id not matched.', async () => {
        ...
        try {
            await request.delete(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/posts/${uuid.v4()}`, {
                json: true,
                headers: {
    ...
    it('should return error when id not correct.', async () => {
        ...
        try {
            await request.delete(`${helpers.API_URL}/api/v1/merchants/${samplePost.merchantID}/posts/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
    ...
    it('should delete doc when all validation pass', async () => {
        ...
        const result = await request.delete(`${helpers.API_URL}/api/v1/merchants/${samplePost.merchantID}/posts/${samplePost._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(result.description).to.equal('Successfully deleted the specified post');
    });
