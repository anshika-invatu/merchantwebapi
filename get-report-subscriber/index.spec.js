...
describe('get-report-subscriber', () => {
    ...
    it('should return error when merchant id not matched.', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/report-subscriber/${sampleReportSubscribers._id}`, {
                json: true,
                headers: {
    ...
    it('should return error when id not correct.', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${sampleReportSubscribers.merchantID}/report-subscriber/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/merchants/${sampleReportSubscribers.merchantID}/report-subscriber/${sampleReportSubscribers._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
