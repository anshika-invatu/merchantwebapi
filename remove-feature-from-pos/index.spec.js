...
describe('Remove feature from pos', () => {
    ...
    it('should throw error if partnerNetworkID field not send in input query', async () => {
        try {
            await request.delete(helpers.API_URL + `/api/v1/point-of-service/${uuid.v4()}/remove-feature-from-pos/123`, {
                json: true,
                headers: {
    ...
    it('should throw error if partnerNetworkID field not send in input query', async () => {
        try {
            await request.delete(helpers.API_URL + `/api/v1/point-of-service/${samplePointOfService._id}/remove-feature-from-pos/123`, {
                json: true,
                headers: {
                    'x-functions-key': process.env.X_FUNCTIONS_KEY,
                    'Authorization': authToken
