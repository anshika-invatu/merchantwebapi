...
module.exports = async (context, req) => {
    ...
    if (!req.body.merchantID) {
        utils.setContextResError(
            ...
            new errors.FieldValidationError(
                'Please provide merchantID field in request body',
                400
            )
        );
        return Promise.reject();
    ...
    try {
        ...
        const result = await request.post(`${process.env.EVENTS_PROCESSOR_API_URL}/api/${process.env.EVENTS_PROCESSOR_API_VERSION}/get-activity-feeds`, {
            json: true,
            body: req.body,
            headers: {
