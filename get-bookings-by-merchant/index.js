...
//Please refer the BASE-311 for further details
...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.post(`${process.env.CUSTOMER_API_URL}/api/${process.env.CUSTOMER_API_VERSION}/merchants/${req.params.id}/bookings`, {
            json: true,
            body: req.body,
            headers: {
