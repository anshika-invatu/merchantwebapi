...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.DEVICE_API_URL}/api/${process.env.DEVICE_API_VERSION}/smart-charging-profiles/${req.params.smartChargingProfilesID}`, {
            json: true,
            headers: {
