...
describe('delete User group', () => {
    ...
    it('should delete doc when all validation pass', async () => {
        ...
        const result = await request.delete(`${helpers.API_URL}/api/v1/merchants/${merchantID}/user-group/${sampleUserGroups._id}`, {
            json: true,
            headers: {
    ...
    it('should not delete doc when module not exist', async () => {
        ...
        try {
            await request.delete(`${helpers.API_URL}/api/v1/merchants/${merchantID}/user-group/${uuid.v4()}`, {
                body: sampleUserGroups,
                json: true,
                headers: {
                    'Authorization': authToken
