...
//Please refer BASE-671 for this endpoint related details
...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.delete(`${process.env.USER_API_URL}/api/${process.env.USER_API_VERSION}/merchants/${req.params.id}/user-group/${req.params.userGroupID}`, {
            json: true,
            headers: {
                'x-functions-key': process.env.USER_API_KEY
            }
