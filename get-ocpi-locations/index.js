...
module.exports = async (context, req) => {
    ...
    try {
        ...
        const result = await request.get(`${process.env.DEVICE_API_URL}/api/${process.env.DEVICE_API_VERSION}/merchant-ocpi-locations?${context.req.originalUrl.split('?')[1]}&merchantID=${req.params.id}`, {
            json: true,
            headers: {
