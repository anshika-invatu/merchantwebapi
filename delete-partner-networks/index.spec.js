...
describe('Delete Partner Network', () => {
    ...
    it('should throw error on incorrect _id field', async () => {
        try {
            await request.delete(helpers.API_URL + `/api/v1/merchants/${merchantID}/partner-networks/123`, {
                json: true,
                headers: {
    ...
    it('should delete document when all validation passes', async () => {
        ...
        expect(result.description).to.equal('Successfully deleted the partnerNetwork of specified details');
    });
