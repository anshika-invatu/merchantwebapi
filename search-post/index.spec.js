...
describe('Search Posts', () => {
    ...
    it('should return error when merchant id not matched.', async () => {
        ...
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/search-posts`, {
                json: true,
                headers: {
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const result = await request.get(`${helpers.API_URL}/api/v1/merchants/${samplePost.merchantID}/search-posts`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
