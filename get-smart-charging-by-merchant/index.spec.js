...
describe('Get SmartChargingProfiles by merchant', () => {
    before(async () => {
    ...
    it('should get doc when all validation pass', async () => {
        ...
        const response = await request.get(`${helpers.API_URL}/api/v1/merchants/${merchantID}/smart-charging-profiles-by-merchant`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(response[0]._id).to.equal(sampleSmartChargingProfiles._id);
    ...
    it('should throw 401 error if the merchantID is not linked to user', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/smart-charging-profiles-by-merchant`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
