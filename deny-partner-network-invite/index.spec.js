...
samplePartnerNetwork.partnerNetworkInvites = new Array();
describe('deny-partner-network-invite', () => {
    ...
    it('should return status code 400 when input query fields are missing', async () => {
        try {
            await request.patch(helpers.API_URL + `/api/v1/merchant/${uuid.v4()}/deny-partner-network-invite`, {
                json: true,
                headers: {
                    'x-functions-key': process.env.X_FUNCTIONS_KEY,
                    'Authorization': authToken
    ...
    it('should throw error on incorrect _id field', async () => {
        try {
            await request.patch(helpers.API_URL + `/api/v1/merchant/${merchantID}/deny-partner-network-invite?partnerNetworkID=123`, {
                json: true,
                headers: {
                    'x-functions-key': process.env.X_FUNCTIONS_KEY,
                    'Authorization': authToken
