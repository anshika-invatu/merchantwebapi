...
describe('Invite Partner Network', () => {
    before(async () => {
        sampleUser.merchants[0].merchantID = merchantID;
    ...
    it('should return status code 400 when request body fields are missing', async () => {
        try {
            ...
            const response = {
                code: 400,
                description: 'Please provide req body parameters partnerNetworkID, invitedMerchantID, merchantID and role',
    ...
    it('should invite partner merchant when all validation passes', async () => {
        ...
        const result = await request.patch(helpers.API_URL + '/api/v1/invite-merchant', {
            ...
            body: {
                ...
                invitedMerchantID: samplePartnerNetwork.partnerNetworkMembers[0].merchantID,
                merchantID: samplePartnerNetwork.partnerNetworkMembers[0].merchantID,
                roles: 'admin'
            }
        });
