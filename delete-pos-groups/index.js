...
//Please refer the story BASE-24 for more details
...
module.exports = async (context, req) => {
    try {
        ...
        const result = await request.delete(`${process.env.DEVICE_API_URL}/api/${process.env.DEVICE_API_VERSION}/pos-groups/${req.params.id}`, {
            json: true,
            headers: {
