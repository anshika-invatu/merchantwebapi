...
describe('Create Teams', () => {
    ...
    it('should throw error if request body is empty', async () => {
        try {
            await request.post(`${helpers.API_URL}/api/v1/team`, {
                json: true,
                headers: {
    ...
    it('should create doc when all validation pass', async () => {
        ...
        const result = await request.post(`${helpers.API_URL}/api/v1/team`, {
            body: sampleTeams,
            json: true,
            headers: {
                'Authorization': authToken
    ...
    it('should return error when req body don\'t have merchantID', async () => {
        sampleTeams._id = uuid.v4();
        sampleTeams.partitionKey = sampleTeams._id;
        delete sampleTeams.merchantID;
        try {
            await request.post(`${helpers.API_URL}/api/v1/team`, {
                body: sampleTeams,
                json: true,
