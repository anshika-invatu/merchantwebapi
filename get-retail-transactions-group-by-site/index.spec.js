...
describe('Get Retail Transactions Grouped By site', () => {
    ...
    it('should throw error if user not login', async () => {
        try {
            const url = `${helpers.API_URL}/api/v1/retail-transaction-group-by-site`;
    ...
    it('should throw error if user not login', async () => {
        try {
            ...
            const response = {
                code: 403,
                description: 'please send the merchantID in the request.',
    ...
    it('should throw error if the documentId is invalid', async () => {
        ...
        expect(result[0].numerOfTransactions).to.eql(0);
